...
const ProjectsSlider = () => {
  ...
  useEffect(() => {
    ...
    }, 2000); // Scroll every 2 seconds - faster auto-scroll
  ...
  // Projects data - Same as Portfolio
                ...
                {projects.map((project, index) => (
                  ...
                  >
                    <div className="backdrop-blur-xl bg-gradient-to-br from-white/10 via-white/5 to-white/3 rounded-2xl border border-white/20 hover:border-[#3ECF8E]/50 transition-all duration-500 overflow-hidden h-full flex flex-col">
                      ...
                      {/* Main Cover Image */}
                      <div className="relative h-56 overflow-hidden cursor-pointer" onClick={() => setSelectedImage(project.image)}>
                        <img 
                          src={project.image}
                          alt={project.title}
