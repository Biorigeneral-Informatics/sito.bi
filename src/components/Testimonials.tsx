...
const Testimonials: React.FC = () => {
  const testimonials: Testimonial[] = useMemo(() => [
    ...
    },
    {
      ...
      avatar: "",
      initials: "AB",
      text: "Abbiamo sviluppato un software per la classificazione rifiuti insieme, hanno fatto un ottimo lavoro nell'identificare i calcoli complessi necessari.",
      rating: 5,
      delay: 0.35,
    },
    {
    ...
    {
      id: 9,
      name: "Co-working WithUs",
      role: "Spazi di Lavoro Condivisi",
      avatar: "",
      initials: "CW",
      text: "Ci siamo affidati a Biorigeneral Informatics per l'implementazione di un ChatBot all'interno del nostro sito web ed il risultato è stato SORPRENDENTE! Non solo il Bot funziona alla perfezione e risponde alle domande ed i dubbi esattamente come avevamo indicato, ma lavorare con i ragazzi di Biorigeneral Informatics è stato un vero piacere. Attenti, gentilissimi, professionali, competenti, sicuri di quelli che fanno e... che dire, non potevamo fare scelta migliore!",
      rating: 5,
      delay: 0.5,
    },
        {
    ...
    {
      id: 11,
      name: "Silvia Nardinocchi",
      role: "Imprenditrice, Consulente",
      avatar: "",
      initials: "SN",
      text: "Non avevo idea di cosa fosse l'A.I., finché non ho conosciuto Federico di Biorigeneral Informatics, e lì si è aperto UN MONDO! Federico mi ha istruito ed insegnato moltissimo, mi ha fatto capire in che modo l'A.I. può accelerare processi di molte ore, mi ha spiegato tutto nel dettaglio e, grazie alla sua consulenza e know-how, la mia produttività lavorativa è migliorata almeno del 50%. Preparato, curioso, professionale, simpatico, attento e... un vero maestro! Grazie!",
      rating: 5,
      delay: 0.6,
    },
    {
