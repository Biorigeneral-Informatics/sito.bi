        ...
        },
        {
          ...
          features: [
            'Integrazione diretta con Meta API per Instagram DM',
              ...
              'App Instagram dedicata per ogni cliente',
              'Knowledge base personalizzata tramite Supabase Vector Store e OpenAI Embeddings',
              'Postgres Chat Memory per mantenere il contesto delle conversazioni',
              'Setup rapido (24–48h) nel pacchetto condiviso',
              'Fino a 5.000 messaggi/mese inclusi nel piano base',
              'AI Gemini Flash inclusa (costo operativo minimo)',
              'Dashboard semplificata per la gestione e monitoraggio delle conversazioni',
              'Aggiornamento documenti fino a 2 volte al mese',
              'Hosting, database e manutenzione inclusi nel piano “tutto incluso”',
              'Architettura Privacy con RLS per isolamento logico dei dati dei clienti',
              'GDPR compliant con DPA standard incluso',
              'Backup automatici giornalieri e audit logging completo',
              'Crittografia AES-256 per la protezione dei dati',
              'Lock-in minimo: possibilità di esportare dati e cancellarli su richiesta',
          ],
          benefits: [
        ...
        },
        {
          ...
          features: [
            'Integrazione tramite Meta Cloud API per WhatsApp Business',
              ...
              'AI Gemini Flash o modello GPT selezionabile in base a qualità/prezzo',
              'Hosting condiviso con isolamento dati tramite RLS PostgreSQL',
              'Knowledge base personalizzabile per ogni cliente, aggiornata mensilmente',
              'Setup una tantum ridotto e attivazione in 24–48h',
              'Manutenzione e DPA inclusi nel piano mensile',
              'Crittografia dei dati (AES-256) e backup giornalieri',
              'Ruolo GDPR definito: cliente come Data Controller, noi come Data Processor',
              'Accesso tramite dashboard unificata (stesso sistema del bot Instagram)',
              'Scalabilità elevata: 1 server condiviso per più clienti con isolamento automatico',
              'Costi operativi minimi (AI + quota server ~€20/mese per cliente)',
              'Margini elevati (≈ 87%) nel piano “tutto incluso”',
              'Facilità di gestione multi-cliente con un’unica infrastruttura centralizzata',
          ],
          benefits: [
            'Aumento lead qualificati',
            'Offri un\'esperienza cliente professionale',
